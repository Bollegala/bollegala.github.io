...
\begin{tabular}{rl}
    \textsc{Name:} & Professor~Danushka Bollegala\\
...
%\textsc{2017.09-current} & Senior Fellow Cookpad PLC  UK, specialising in cooking recipe analysis\\
 %\textsc{2017.01-current} & Advisor BrainPad PLC Japan, specialising in deep learning applications \\
  \textsc{2026.04-current} & Advisor Sekisui Chemicals, Japan, Vision Action Language Models for Chemical robotic manupulation.\\
...
\textsc{2026} & \textbf{Co-organiser} Third NLP for Social Good Workshop at IJCAI-EACI 2026\\
\textsc{2024} & \textbf{Program Chair} *SEM 2024 (13th Joint Conference on Lexical and Computational Semantics) at NAACL 2024 in Mexico City, Mexico\\
\textsc{2024} & \textbf{Co-organiser} Second NLP workshop for Social Good Symposium at University of Liverpool\\
\textsc{2023} & \textbf{Co-organiser} First NLP workshop for Social Good Symposium at University of Liverpool\\
...
2026 & Senior Area Chair, EMNLP-2026\\
2026 & Senior Area Chair, ACL-2026\\
2025 & Senior Area Chair, EMNLP-2024\\
...
Total research income so far GBP 4, 262, 857.

\begin{enumerate}

\item \textbf{Application of Multimodal AI in Autonomous Experiments}, Sekisui Chemicals, PI (GBP 160,500), 2026-2028.
...
\begin{enumerate}
\item Guanqun Cao, March 2024 (Co-supervised with Shan Luo), now Lecturer at University of West England, Bristol, UK.
\item Samantha Durdy, March 2023 (Co-supervised with Matt Rosseinsky and Micheal Gaultois.
...
\item Nguyen Tuan Duc, graduated March 2011, now Vice President at Alt+.
...
\begin{enumerate}
\item Francesco Periti, University of Milan, Italy, October, 2024.
...
\begin{enumerate}
\item Panelist at the panel on \emph{Data mining in research: Navigating the Ethics Frontier} organised at the Digital Universities UK conference, 2026.
\item Talk given at Sekisui Chemical, a Japanese company specialising in material innovations, on the Deep Learning approaches to novel material discovery, 2025.
\item Talk given at Sakana AI, a Tokyo-based startup specialising in nature-inspired deep learning methods, 2025.
\item Invited talk delivered to the Department of Computer Science at Manchester Metropolitan University (MMU) on Diverse Commonsense Generation, 2025.
\item Invited talk at the LLMFinLegal workshop at COLING in Abu Dhabi, UAE, 2025.
\item \emph{Hype vs. Hope: How Gen AI be deployed to boost and create public value?} panelist at the panel organised by the Institute for Public Policy Research (IPPR) at the Labour Party Conference, Liverpool, 2024.
...
I have published over 200 papers in top international venues in Natural Language Processing, Machine Learning, Data Mining, Artificial Intelligence, and Social Media Analysis.My papers have been cited 7247 times with an $h$-index of 44 and i10-index of 125.
